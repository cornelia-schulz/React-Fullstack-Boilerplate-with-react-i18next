...
function getAllCats() {
  return _superagent2.default.get('/api/v1/cats').then(function (res) {
    return res.body;
  }).catch(function (err) {
    console.error(err);
  });
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _apiClient.getAllCats)().then(function (cats) {
      ...
      return _react2.default.createElement(
        ...
        function (t, _ref) {
          ...
          return _react2.default.createElement(
            ...
            _this3.state.cats && _react2.default.createElement(
              'ul',
              null,
              _this3.state.cats.map(function (cat) {
                return _react2.default.createElement(
                  'li',
                  { key: cat.id },
                  cat.name
...
var _i18nextBrowserLanguagedetector = __webpack_require__(/*! i18next-browser-languagedetector */ "./node_modules/i18next-browser-languagedetector/index.js");
...
_i18next2.default.use(_i18nextXhrBackend2.default).use(_i18nextBrowserLanguagedetector2.default).use(_reactI18next.reactI18nextModule).init({
  fallbackLng: 'en',
...
__webpack_require__(/*! ./i18n */ "./client/i18n.js");
